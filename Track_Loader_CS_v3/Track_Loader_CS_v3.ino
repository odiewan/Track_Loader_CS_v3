...
void setup() {
  ...
  // rtsThr = new rxToSrvo("Thr", RX_CH0_PIN, SVO_3_PIN, SVO_CMD_GAIN_INV,
  // SVO_CMD_OFFSET, 1); rtsAil = new rxToSrvo("Ail", RX_CH1_PIN, SVO_0_PIN,
  // SVO_CMD_GAIN_INV, SVO_CMD_OFFSET, 1); rtsEle = new rxToSrvo("Ele",
  // RX_CH2_PIN, SVO_1_PIN, SVO_CMD_GAIN_INV, SVO_CMD_OFFSET, 1); rtsRud = new
  // rxToSrvo("Rud", RX_CH3_PIN, SVO_2_PIN, SVO_CMD_GAIN_INV, SVO_CMD_OFFSET,
  // 1);
